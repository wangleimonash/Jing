...
public interface UserDao {
    ...
    List<UserInfo> getUserInfoByIdsNew(UserInfoQuery info) throws Exception;
    
    List<Map<String,Object>> getUserInfoAndPosition(UserInfoQuery info) throws Exception;
    Long getCountUserInfoAndPosition(UserInfoQuery info) throws Exception;
    
//    查询出勤人数
    List<UserInfo> getShouldWorkUser(Map<String,Object> map) throws Exception;
    List<UserInfo> getShouldWorkUserFromCompany(Map<String,Object> map) throws Exception;
    List<UserInfo> getShouldWorkUserFromSection(Map<String,Object> map) throws Exception;
    List<UserInfo> getShouldWorkUserFromProject(Map<String,Object> map) throws Exception;
    
    Long getActWorkCount(Map<String,Object> map) throws Exception;
    Long getlateWorkCount(Map<String,Object> map) throws Exception;
    
    
    //实时监控查询安全帽人员位置
    List<UserInfo> getUserAndPositionByIds(UserInfoQuery queryInfo) throws Exception;
}
