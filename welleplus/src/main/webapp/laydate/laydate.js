/*! laydate-v5.0.4 日期与时间组件 MIT License  http://www.layui.com/laydate/  By 贤心 */
;!function () {
    "use strict";
    var e = window.layui && layui.define, t = {
            ...
            ready: function (a) {
                ...
                return "function" == typeof define && define.amd ? a() : (e ? layui.addcss(o, a, i) : t.link(o, a, i), this)
            }
        }, a = function () {
            var e = this;
            return {
        ...
        d = [100, 2e5], c = "layui-laydate-list", m = "laydate-selected", u = "layui-laydate-hint",
        h = "laydate-day-prev", y = "laydate-day-next", f = "layui-laydate-footer", p = ".laydate-btns-confirm",
        g = "laydate-time-text", v = ".laydate-btns-time", D = function (e) {
            var t = this;
    ...
    w.prototype = [], w.prototype.constructor = w, T.extend = function () {
        ...
        t.elem = T(t.elem), t.eventElem = T(t.eventElem), t.elem[0] && (t.value && e.setValue(t.value), t.range === !0 && (t.range = "-"), t.format === i.date && (t.format = i[t.type]), e.format = t.format.match(new RegExp(n + "|.", "g")) || [], e.EXP_IF = "", e.EXP_SPLIT = "", T.each(e.format, function (t, a) {
        ...
        if (t.zIndex && (i.style.zIndex = t.zIndex), T.each(new Array(2), function (e) {
                ...
                var a = T.elem("div", {"class": "layui-laydate-header"}), i = [function () {
                        ...
                        return e.innerHTML = "&#xe65b;", e
                    }()], d = T.elem("div", {"class": "layui-laydate-content"}), c = T.elem("table"), m = T.elem("thead"),
                    u = T.elem("tr");
        ...
        var t, a, i, r = this, s = r.config, l = e || s.dateTime, c = new Date, m = r.lang(),
            u = "date" !== s.type && "datetime" !== s.type, h = e ? 1 : 0, y = T(r.table[h]).find("td"),
        ...
        var n = this, a = n.config, i = a.dateTime, r = n.lang(),
            l = a.range && "date" !== a.type && "datetime" !== a.type, d = T.elem("ul", {
                "class": c + " " + {
                    year: "laydate-year-list",
                    month: "laydate-month-list",
                    time: "laydate-time-list"
                }[e]
            }), m = n.elemHeader[t], u = T(m[2]).find("span"), h = n.elemCont[t || 0], y = T(h).find("." + c)[0],
            f = "cn" === a.lang, D = f ? "年" : "", w = n.listYM[t] || {}, x = ["hours", "minutes", "seconds"],
        ...
        var a, i = this, r = i.config, o = T(i.footer).find(p),
        ...
        var n = this, a = n.config, i = T.extend({}, n.startDate ? T.extend(n.startDate, n.startTime) : a.dateTime),
        ...
        var t = this, n = t.config, a = n.dateTime, i = T(t.elem).find("td"), r = e.attr("lay-ymd").split("-"),
            l = function (e) {
                new Date;
        ...
        var t = this, n = t.config, a = n.dateTime, i = n.range && ("year" === n.type || "month" === n.type),
            r = t.elemCont[e || 0], o = t.listYM[e], s = function (s) {
                var l = ["startDate", "endDate"][e], d = T(r).find(".laydate-year-list")[0],
