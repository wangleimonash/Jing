app.service('fenceServer',function($q,$http){
	...
	//出勤统计
	this.getWorkInfos = function(fence){
		var deferred = $q.defer();
		$http.get("/welleplus/fence/getworkinfos.do?role="+fence.role+"&rid="+fence.rid+"&uid="+fence.uid+"&desc="+fence.desc+"&descId="+fence.descId).success(function(data){
			deferred.resolve(data);
		}).error(function(){
			deferred.reject();
		});
	...
	this.getFenceInfos = function(fence){
		var deferred = $q.defer();
		$http.get("/welleplus/fence/getFenceInfos.do?role="+fence.role+"&rid="+fence.rid+"&uid="+fence.uid+"&desc="+fence.desc+"&descId="+fence.descId+"&page="+fence.page).success(function(data){
			deferred.resolve(data);
		}).error(function(){
			deferred.reject("查询失败");
		});
	...
	this.getNewWorkInfos = function(fence){
		var deferred = $q.defer();
		$http({
			method:"post",
			url:"/welleplus/fence/getnewworkinfos.do",
			data:fence,
			dataType:"json"
		}).success(function(data){
			deferred.resolve(data);
	...
	this.getWorkPie = function(){
		var deferred = $q.defer();
		$http.get("/welleplus/fence/getworkpie.do").success(function(data){
			deferred.resolve(data);
		}).error(function(){
			deferred.reject("查询失败");
		});
